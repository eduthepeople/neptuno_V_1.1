        ...
        <div class="col-lg-12">
            <div class="card panel-primary ">
                <div class="card-heading clearfix">
                    ...
                    <a href="{{ route('groups.create') }}" class="btn btn-sm btn-default"><span class="fa fa-plus"></span> @lang('button.create')</a>
                    </div>
                </div>
                <br />
                <div class="card-body">
                                    ...
                                    <td>
                                        <a href="{{ route('groups.edit', $role->id) }}">
                                            ...
                                            @if ($role->id !== 1)
                                                ...
                                                @else
                                                    <a href="{{ route('groups.confirm-delete', $role->id) }}" data-toggle="modal" data-id ="{{ $role->id }}" data-target="#delete_confirm">
